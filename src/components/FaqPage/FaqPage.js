...
export default function FaqPage() {
  return (
    <div className="main">
      ...
      <div>
        <h3 className="app-subtitle">For Students & Medical Professionals</h3>
        <div className="question-block">
          <div className="data-item column">
            <h4>How much does using findshadowing.com cost?</h4>
            <span>Absolutely nothing. This is a free service to connect working professionals with students hoping to gain shadowing experience.</span>
          </div>
          <div className="data-item column">
            <h4>By signing up, am I committing to anything?</h4>
            <span>No. Students send shadowing requests at their discretion and medical professionals respond to shadowing requests at their discretion. By signing up for findshadowing.com, you are not committing to any set number of shadowing students or hours or any requirements.</span>
          </div>
          <div className="data-item column">
          ...
          <div className="data-item column">
            <h4>How often can I request a specific professional?</h4>
            <span>You can only request them once every 60 days. At 60 days, if your request has not been approved or denied, it is removed. You may then request the same professional again.</span>
          </div>
        </div>
      </div>
      <div>
        <h3 className="app-subtitle">For Medical Professionals</h3>
        <div className="question-block">
          <div className="data-item column">
