      ...
      <div className="modal-content">
        ...
        <div className="modal-text">
          <div className="form">
            ...
            <h3 className="app-subtitle">You're request to shadow has been submitted!</h3>
            <div className="data-item">
              <p>You should receive a confirmation email shortly.</p>
            </div>
            <div className="data-item">
              <p>The provider will reach out to you to either accept for deny this request, and for further scheduling. Please note, if the request has not been responded to within 60 days it will be automatically deleted.</p>
            </div>
            <div className="data-item">
